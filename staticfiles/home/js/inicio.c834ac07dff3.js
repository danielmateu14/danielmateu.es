document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================================
    // Reveal scroll-driven de la sección "Mis Proyectos"
    // Inspirado en el efecto modern-hero (clip-path + parallax).
    // Actualiza la variable CSS --p (0 → 1) según cuánto se ha
    // desplazado la sección dentro del viewport. El resto del
    // efecto (clip-path, transforms, fade escalonado) vive en CSS.
    // ============================================================
    (function initProyectosReveal() {
        const section = document.querySelector('.proyectos-section');
        if (!section) return;

        // Respeta la preferencia del usuario: sin animación, todo visible.
        ...
        function updateReveal() {
            ...
            const start = vh * 0.95; // empieza a revelarse al asomar por abajo
            const end = vh * 0.35;   // totalmente revelada
        ...
        updateReveal(); // estado inicial (por si ya está en pantalla)
    })();
});